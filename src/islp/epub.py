...
p.li2         { text-indent: -1.1em; margin-left: 3.0em; margin-top: 0.35em; }
p.li2-cont    { text-indent: 0;      margin-left: 3.0em; }
p.li2-cont-in { text-indent: 1.2em;  margin-left: 3.0em; }
p.li .marker, p.li2 .marker { font-weight: bold; }
